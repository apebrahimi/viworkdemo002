...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            cert_server_url: "https://cert.viworks.local".to_string(),
            spki_pins: SpkiPins {
            ...
            binary_paths: BinaryPaths {
                fwknop: PathBuf::from(r"C:\Program Files\ViWorkS\bin\fwknop.exe"),
                openvpn: PathBuf::from(r"C:\Program Files\ViWorkS\bin\openvpn.exe"),
            },
