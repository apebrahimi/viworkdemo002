...
# 🚀 GitHub Actions Setup Script for ViWorks Website
# This script helps you set up the required secrets and configuration

set -e

echo "🚀 Setting up GitHub Actions CI/CD for ViWorks Website"
echo "=================================================="
...
echo ""
echo "🎉 Setup complete! Your website will auto-deploy on every push to main."
