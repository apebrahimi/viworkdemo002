...
# ViWorkS Gateway Agent - Alpine Linux Build Script (Simplified)
...
print_status "Building ViWorkS Gateway Agent for Alpine Linux (Simplified)..."
...
# Check dependencies (skip strict linting)
