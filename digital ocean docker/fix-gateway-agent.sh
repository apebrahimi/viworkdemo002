...
echo "🔧 Fixing Gateway Agent and Continuing Cleanup"
echo "=============================================="
...
scp -i ~/.ssh/id_ed25519 fix_gateway_script.sh root@64.227.46.188:/tmp/

echo "🔧 Making script executable and running it..."
ssh -i ~/.ssh/id_ed25519 root@64.227.46.188 "chmod +x /tmp/fix_gateway_script.sh && /tmp/fix_gateway_script.sh"

# Clean up
rm -f fix_gateway_script.sh

echo ""
echo "✅ Gateway agent fix and cleanup completed!"
